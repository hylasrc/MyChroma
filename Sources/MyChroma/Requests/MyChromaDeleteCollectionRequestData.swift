//
//  MyChromaDeleteCollectionRequestData.swift
//  MyChroma
//
...
public struct MyChromaDeleteCollectionRequestData {
  internal var path: Self.Path
  internal var queries: Self.Query
  internal var body: Self.Body

  public init(collectionName: String, tenant: String, database: String) {
